...
> 🧩 **代码:** https://github.com/Social-AI-2026/worldcup2026-codebase
> 📦 **数据:** https://huggingface.co/datasets/Social-AI-2026/worldcup2026
...
预测和真实赛果都在 **[代码仓库](https://github.com/Social-AI-2026/worldcup2026-codebase)** 的 `wc_runs/archive/` 里。那边的 `update_web.py` 把它们写进 `worldcup-data.js`(`PRED` 对象)和 `worldcup-arena.js`(`RESULTS`),并 bump `index.html` 的 `?v=` 缓存戳。
